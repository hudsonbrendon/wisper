...
export function WisperLogoStack({ className = "" }: { className?: string }) {
  return (
    <div className={"flex flex-col items-center " + className}>
      <img src="/logo-animado.svg" alt="" className="mb-3 h-20 w-20" />
...
// The Google "G", rendered in currentColor so it stays visible on both the
// dark (light theme) and light (dark theme) sign-in buttons.
